...
{
    public class WeatherCelsiusCommand : Command
    {
        protected override string Name => "/weathercelsius";
        ...
        public override async void Execute(Message message, TelegramBotClient client)
        {
            ...
            if (!weatherDataLoadStatus)
            {
                await client.SendTextMessageAsync(chatId,
                                                  ...
                                                  "Command example: \"/weathercelsius London\"",
                                                  replyToMessageId: messageId);
                return;
            }

            weatherInfo.SetGetTemparatureBehaviour(new GetTemperatureCelsius());
